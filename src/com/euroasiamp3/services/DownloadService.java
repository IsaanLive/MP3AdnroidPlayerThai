...
import com.euroasia.th.DownloadingActivity;
import com.euroasia.th.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("การดาวน์โหลดถูกยกเลิก","ยกเลิก: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("การดาวน์โหลดล้มเหลว","ล้มเหลว: "+filename,filename); 
				http--;
				...
				regularNotif("การดาวน์โหลดเสร็จสมบูรณ์","เสร็จ: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "คลิกที่นี่เพื่อดูความคืบหน้า", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
