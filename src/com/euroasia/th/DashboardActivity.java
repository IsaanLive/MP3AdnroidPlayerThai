...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_SUBJECT, "โปรแกรมดาวน์โหลด MP3");
				i.putExtra(Intent.EXTRA_TEXT, "ด้วยฟังก์ชั่นการค้นหาที่มีประสิทธิภาพ "+getString(R.string.app_name)+" ได้รวบรวมเพลงที่มีคุณภาพสูงนับล้านมาให้คุณ คุณสามารถฟังเพลงออนไลน์หรือดาวน์โหลดได้ฟรี เฉลิมฉลองกับเทศกาลฟังเพลงได้เลยในขณะนี้ "+getString(R.string.app_name)+" Download Link: https://market.android.com/details?id="+getString(R.string.market_url));
				startActivity(Intent.createChooser(i, "แบ่งปันแอพพลิเคชัน"));
        	}
		});
		...
		if(!isInternetConnectionActive(getApplicationContext())) {
			...
			builder.setMessage("คุณต้องเชื่อมต่ออินเทอร์เน็ตที่ใช้งานได้เพื่อให้สามารถใช้คุณสมบัติจากแอพพลิเคชั่นนี้ได้อย่างเต็มที่ กรุณาไปที่การตั้งค่าของคุณและเปิดการใช้งาน WiFi!")
				   .setCancelable(false)
				   .setPositiveButton("การตั้งค่า", new DialogInterface.OnClickListener() {
	...
	public void rateapp(){		
		...
		if(hasBeenShown == false){
			String title = "ให้คะแนนเราบน Android Market";
			
			String message = "ถึงผู้ใช้ทุกท่าน ถ้าคุณต้องการโปรแกรมของเราโปรดให้เรา 5 ดาว การสนับสนุนอย่างต่อเนื่องของคุณจะช่วยให้เราพัฒนาได้ดียิ่งขึ้น";
 
			AlertDialog.Builder builder = new AlertDialog.Builder(this)
					.setTitle(title)
					.setMessage(message)
					.setPositiveButton("ให้คะแนน", new Dialog.OnClickListener() {
					...
					.setNegativeButton("ยกเลิก", new Dialog.OnClickListener() {
